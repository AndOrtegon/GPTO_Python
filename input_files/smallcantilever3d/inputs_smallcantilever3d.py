...
FE['mesh_input']['box_dimensions'] = np.array( (10,5,5) )
...
FE['mesh_input']['bcs_file'] = 'input_files/smallcantilever3d/setup_bcs_smallcantilever3d.py'
...
GEOM['initial_design'] = { 
    'path':'input_files/smallcantilever3d/initial_smallcantilever3d_geometry.py' ,
    'plot':plot_cond ,
    'restart':False}
...
OPT['functions']['constraint_limit'] = [0.23]
